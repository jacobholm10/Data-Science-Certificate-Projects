...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        ...
        site_success_counts = spacex_df.groupby('Launch Site')['class'].sum()
        site_failure_counts = spacex_df.groupby('Launch Site')['class'].count() - site_success_counts

       
        site_success_rates = site_success_counts / (site_success_counts + site_failure_counts)
...
def get_scatter_chart(entered_site, selected_payload_range):
    if entered_site == 'ALL':
        ...
        fig = px.scatter(spacex_df,
                        ...
                        title='Payload Mass (kg) of All Sites',
        ...
        fig = px.scatter(filtered_df,
                        ...
                        y='class',
                        color='Booster Version Category',
                        title=f"{entered_site} for Payload Mass and Class",
                        labels={'Payload Mass (kg)': 'Payload Mass (kg)', 'class': 'Class'})
